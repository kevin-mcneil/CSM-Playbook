...
This folder contains AI prompts that support workflows, analysis, and preparation for Customer Success Managers. These prompts come directly from the AI Companion System and are used for stakeholder mapping, motivation analysis, and role specific understanding.
...
Use the outputs from the stakeholder map and motivation table to tailor future communication, agenda setting, and proactive outreach.
